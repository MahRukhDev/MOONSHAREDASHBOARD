        ...
        A =
          ...
          (function (e) {
            ...
            function t() {
              ...
              (0, l.Z)(this, t);
              for (
                var o = arguments.length, c = new Array(o), d = 0;
                d < o;
                d++
              )
                c[d] = arguments[d];
              return (
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                if (
                                  ((document.title = "Dashboard | MOONSHARE"),
                                  (a = "undefined" !== typeof window.ethereum),
                                  (s.walletConnectProvider = new N.Z({
                                    rpc: {
                                ...
                                (t = new B.providers.HttpProvider(
                              ...
                              case 13:
                                return (
                                  (s.networkId = e.sent),
                                  (e.next = 16),
                                  s.web3.eth.getAccounts()
                                );
                              case 16:
                                (s.accounts = e.sent),
                                  (s.currentAccount = s.accounts[0]),
                                  s.currentAccount &&
                                    s.setState({
                                      walletAddress: s.currentAccount,
                                    }),
                                  (e.next = 26);
                                break;
                              case 21:
                                (e.prev = 21),
                                  (e.t0 = e.catch(9)),
                                  (i = new B.providers.HttpProvider(
                                    "https://bsc-dataseed1.ninicoin.io"
                                  )),
                                  (s.web3 = new B(i)),
                                  (s.networkId = 56);
                              case 26:
                                return (
                                  56 != s.networkId &&
                                    ((l = new B.providers.HttpProvider(
                                      "https://bsc-dataseed1.ninicoin.io"
                                    )),
                                    (s.web3 = new B(l)),
                                    (s.networkId = 56)),
                                  (s.Instance = new s.web3.eth.Contract(
                                    b.Mt,
                                    s.state.TokenContractAddress
                                  )),
                                  (s.Instance2 = new s.web3.eth.Contract(
                                    y.Mt,
                                    s.state.RewardContractAddress
                                  )),
                                  (s.pcsContract = new s.web3.eth.Contract(
                                    k.Mt,
                              ...
                              case 32:
                                return (
                                  (o = e.sent),
                                  (e.next = 35),
                                  s.Instance.methods.symbol().call()
                                );
                              case 35:
                                return (
                                  (r = e.sent),
                                  (e.next = 38),
                                  s.Instance.methods.decimals().call()
                                );
                              case 38:
                                return (
                                  (c = e.sent),
                                  (e.next = 41),
                                  s.Instance.methods.totalSupply().call()
                                );
                              case 41:
                                return (
                                  (d = e.sent),
                                  (d = parseFloat(d / Math.pow(10, c))),
                                  (e.next = 45),
                                  s.Instance.methods
                                    .balanceOf(
                              ...
                              case 68:
                                return (
                                  (D = e.sent) > 0 &&
                                    (D = parseFloat(D / Math.pow(10, 18))),
                                  (e.prev = 70),
                                  (e.next = 73),
                                  w.Z.get(
                                    "tokens/" + s.state.TokenContractAddress
                                  ).then(function (e) {
                                    return e.data.pairs;
                                  })
                                );
                              ...
                              case 80:
                                return (
                                  ...
                                  (M =
                                    A.result[
                                      "0xfb1b29e497BCE8B268E488d2D6d3db8DF286777E"
                                    ]),
                                  (P = 0),
                                  ...
                                  M.lp_holders.map(function (e, a) {
                                    1 == e.is_locked &&
                                      (S += parseFloat(e.percent));
                                  }),
                                  s.setState({
                                    TotalDividendHolders: p,
                                    top10_holders_ratio: 100 * P,
                                    lp_holders: M.lp_holder_count,
                                    per_of_lp_locked: 100 * S,
                                  }),
                                  1701414e6,
                                  (E = new Date().getTime()),
                                  (I = function (e) {
                                  ...
                                  (j =
                                    ...
                                    ":" +
                                    I(H)),
                                  (U = new s.web3.eth.Contract(
                                    b.Mt,
                                    "0x55d398326f99059fF775485246999027B3197955"
                                  )),
                                  (e.next = 99),
                                  U.methods
                                    .balanceOf(s.state.RewardContractAddress)
                                    .call()
                                );
                              case 99:
                                return (
                                  (z = e.sent),
                                  (e.next = 102),
                                  Z.utils.fromWei(z, "ether")
                                );
                              case 102:
                                (z = e.sent),
                                  s.setState({
                                    lp_locked_duration: j,
                                    Liquidity: T[0].liquidity.usd,
                                    tradeVolume: T[0].volume.h24,
                                    totalPendingRewards: z,
                                  }),
                                  (e.next = 109);
                                break;
                              case 106:
                              ...
                              case 112:
                                (O = e.sent),
                                  (V = Number(O[2])),
                                  (V = parseFloat(V / Math.pow(10, 18))),
                                  s.setState({
                                    tokenPriceinUSD: parseFloat(V).toFixed(12),
                                  }),
                                  (e.next = 122);
                                break;
                              case 118:
                                (e.prev = 118),
                                  ...
                                  s.setState({
                                    tokenPriceinUSD: parseFloat(0).toFixed(12),
                                  });
                              case 122:
                                s.setState({
                                  MarketCap: d * s.state.tokenPriceinUSD,
                                  totalRewardsDistributed: D,
                                }),
                                  s.setState({
                                    loader: "none",
                                    content: "block",
                ...
                (0, u.Z)((0, r.Z)(s), "test", function (e) {
                  return Math.abs(Number(e)) >= 1e12
                    ? {
                        value: (Math.abs(Number(e)) / 1e12).toFixed(2),
                        symbol: "T",
                      }
                    : Math.abs(Number(e)) >= 1e9
                    ? {
                        value: (Math.abs(Number(e)) / 1e9).toFixed(2),
                        symbol: "B",
                      }
                    : Math.abs(Number(e)) >= 1e6
                    ? {
                        value: (Math.abs(Number(e)) / 1e6).toFixed(2),
                        symbol: "M",
                      }
                    : Math.abs(Number(e)) >= 1e3
                    ? {
                        value: (Math.abs(Number(e)) / 1e3).toFixed(2),
                        symbol: "K",
                      }
                          ...
                          switch ((e.prev = e.next)) {
                            case 0:
                              s.setState({
                                ...
                                window.localStorage.setItem("connected", "no"),
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  (e.prev = 0),
                                  (e.next = 3),
                                  s.walletConnectProvider.enable()
                                );
                              case 3:
                                return (
                                  (s.web3 = new B(s.walletConnectProvider)),
                                  (e.next = 6),
                                  s.web3.eth.getAccounts()
                                );
                              case 6:
                        ...
                        return n().wrap(function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                (t = a.target.value),
                                  a.target.value > 0 && s.holderInfo(t);
                              case 2:
                              case "end":
                                return e.stop();
                            }
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                ...
                                return (
                                  s.setState({
                                    loaded: !0,
                                    claimbtnText: "Processing...",
                                  }),
                                  (a = new s.web3.eth.Contract(
                                    b.Mt,
                                    s.state.TokenContractAddress
                                  )),
                                  (e.next = 7),
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                if (
                                  ...
                                  !T.validate(a, "ETH", "both"))
                                ) {
                                  e.next = 39;
                                  break;
                                }
                                return (
                                  s.setState({ walletAddress: a }),
                                  (e.next = 6),
                                  s.Instance.methods.balanceOf(a).call()
                                );
                              case 6:
                                return (
                                  (t = e.sent),
                                  (e.next = 9),
                                  Z.utils.fromWei(t, "gwei")
                                );
                              case 9:
                                return (
                                  (i = e.sent),
                                  s.setState({ tokenBalance: i }),
                                  (e.next = 13),
                                  s.Instance.methods
                                    .getAccountDividendsInfo(a)
                                    .call()
                                );
                              case 13:
                                if (
                              ...
                              case 25:
                                (e.t1 = e.sent),
                                  ...
                                  (x = ((f / w) * 100).toFixed(0)),
                                  (g = 100 - x + "%"),
                                  s.setState({ nextAutoClaim: "Processing" }),
                                  (e.next = 36);
                                break;
                              case 34:
                                (g = "0%"),
                              ...
                              case 36:
                                (N =
                                  (N = l[3]) > 0
                                    ? parseFloat(N / Math.pow(10, 18))
                                    : 0),
                                  s.setState({
                                    lastClaimTime: r,
                                    withdrawableDividends: N,
                                    totalDividends: o,
                                  });
                              case 39:
                              case "end":
                    ...
                    return C(
                      ...
                      C(
                        ...
                        C(
                          ...
                          {
                            className:
                              "wrapper vertical-layout navbar-floating footer-static vertical-overlay-menu menu-hide",
                            id: "menu",
                          },
                          C(
                            "div",
                              ...
                              C(
                                ...
                                C(
                                  ...
                                  C(
                                    ...
                                    {
                                      className:
                                        "nav-link modern-nav-toggle cursor-pointer",
                                    },
                                    C(
                                      "svg",
                                      {
                                ...
                                C(
                                  ...
                                  C(
                                    ...
                                    C(
                                      ...
                                      C("path", {
                                        fill: "currentColor",
                                        d: "M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10zm0-13H8v2h9l-5-5v3zm-5 4l5 5v-3h4v-2H7z",
                                      })
                                    ),
                                    C(
                                      "span",
                          ...
                          C(
                            ...
                            {
                              className:
                                "header-navbar navbar align-items-center floating-nav navbar-shadow navbar navbar-expand-lg navbar-light",
                            },
                            C(
                              "div",
                              ...
                              C(
                                ...
                                C(
                                  ...
                                  {
                                    className:
                                      "mobile-menu me-auto d-flex align-items-center nav-item",
                                  },
                                  C(
                                    "a",
                                    {
                                      id: "showSideMenu",
                                      className:
                                        "nav-menu-main menu-toggle hidden-xs is-active nav-link",
                                    },
                                    C(
                                      "svg",
                                      {
                              ...
                              C(
                                "ul",
                                {
                                  style: { display: "flex" },
                                  className:
                                    "nav navbar-nav align-items-center ms-auto",
                                },
                                C(
                                  "span",
                                  null,
                                        ...
                                        C(
                                          ...
                                          C(
                                            "li",
                                            {
                                              id: "connected",
                                              className:
                                                "dropdown-user nav-item dropdown",
                                            },
                                            C(
                                              "a",
                                              {
                                                href: "#",
                                                onClick: this.connectedBTNClick,
                                                "aria-haspopup": "true",
                                                className:
                                    ...
                                    : C(
                                        ...
                                        C(
                                          "button",
                                          {
                                            ...
                                            disabled:
                                              this.state.connectbtnDisabled,
                                            id: "btn-connect",
                                            type: "button",
                                            className:
                                              "waves-effect round btn btn-outline-primary btn-sm",
                                          },
                                          C(
                                            "span",
                                            {
                      ...
                      C(
                        ...
                        C(
                          ...
                          {
                            className:
                              "content-wrapper animate__animated animate__fadeIn",
                          },
                          C(
                            "div",
                            null,
                                  ...
                                  C(
                                    ...
                                    C(
                                      ...
                                      C(
                                        "span",
                                        { className: "ms-1" },
                                        "Please connect your wallet or enter the valid wallet address to see user specific token balance."
                                      )
                                    )
                                  )
                                ),
                            C(
                              ...
                              C(
                                ...
                                C(
                                  ...
                                  {
                                    className:
                                      "input-group-merge mb-1 input-group",
                                  },
                                  C(
                                    "span",
                                  ...
                                  C(
                                    ...
                                    C(
                                      ...
                                      C(
                                        ...
                                        {
                                          className:
                                            "avatar avatar-stats p-50 m-0 bg-light-primary",
                                        },
                                        C(
                                          "div",
                                ...
                                C(
                                  ...
                                  C(
                                    ...
                                    C(
                                      ...
                                      {
                                        className:
                                          "d-flex justify-content-between align-items-center buyback-card",
                                      },
                                      C(
                                        "button",
                                        {
                                          ...
                                          type: "button",
                                          className:
                                            "waves-effect round btn btn-outline-primary btn-lg",
                                        },
                                        C(
                                          "span",
                                          {
                                    ...
                                    ? C(
                                        ...
                                        C(
                                          ...
                                          C(
                                            ...
                                            {
                                              className:
                                                "data-info-widget-container",
                                            },
                                            C(
                                              "div",
                                              { className: "data-info-type" },
                                              "Contract Address:"
                                            ),
                                            C(
                                              "div",
                                              {
                                                className: "data-info-row-end",
                                              ...
                                              C(
                                                ...
                                                C(
                                                  "div",
                                                  {
                                                    className:
                                                      "data-info-value",
                                                    id: "tokenMetaDataInfo",
                                                  },
                                                  this.state.TokenContractAddress.substring(
                                                    0,
                                                    6
                                                  ) +
                                                    "..." +
                                          ...
                                          C(
                                              ...
                                              C(
                                                ...
                                                C(
                                                  ...
                                                  C(
                                                    ...
                                                    this.state.RewardContractAddress.substring(
                                                      0,
                                                      6
                                                    ) +
                                                      "..." +
                                              ...
                                              C(
                                                ...
                                                C(x.ZP, {
                                                  ...
                                                  start: 0,
                                                    ...
                                                    .CurrentDividendProcessingIndex,
                                                  duration: 2.75,
                                                  useEasing: !0,
                                                  useGrouping: !0,
                                                  separator: ",",
                                            ...
                                            C(
                                              ...
                                              C(
                                                "div",
                                                { className: "data-info-type" },
                                                "Rewards Distribution Completion: "
                                              ),
                                              C(
                                                "div",
                                                {
                                            ...
                                            C(
                                              ...
                                              {
                                                className:
                                                  "data-info-progress-tracker mt-2",
                                              },
                                              C(
                                                "div",
                                                {
                                  ...
                                  C(
                                    ...
                                    C(
                                      ...
                                      C(
                                        ...
                                        C(
                                          ...
                                          { className: "logo" },
                                          C("img", {
                                            src: "/media/metamask.b6b09bd4.svg",
                                    ...
                                    C(
                                      "div",
                                      {
                                        ...
                                        className: "walletconnect-connector",
                                      },
                                      C(
                                        "div",
                                        {
                                        ...
                                        C(
                                          ...
                                          C("img", {
                                            ...
                                            src: "/media/wallet-connect.c0072cb0.svg",
